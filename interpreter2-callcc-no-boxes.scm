...
(define function-frame
  (lambda (statement environment throw)
    (if (matching-parameters? (function-params statement environment) (parameter-values (parameters statement) environment throw))
      (cons (function-params statement environment) (cons (list (parameter-values (parameters statement) environment throw) (find-instance-closure (instance (get-dot-expr statement)) environment)) '()))
